...
import com.intelligence.GlobalApplication;
...
public class Intelligence {
    ...
    public static Configurator configurator = new Configurator("."+File.separator+"config.xml", GlobalApplication.getAppContext());
    ...
    public Intelligence(boolean enableReportGeneration, Canvas cnv, View cnvView) throws Exception {
    	 ...
    	 */
    	Log.d(TAG,"Processing was started! Please wait few minutes...");
